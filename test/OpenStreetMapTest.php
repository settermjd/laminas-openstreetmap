...
class OpenStreetMapTest extends TestCase
{
    ...
    public function testCanSearchForAnAddressWithAValidAddress(): void
    {
...
EOF;
        ...
        $this->assertSame($resultBody, $osm->search($searchQuery, ResponseFormat::JSON));
    }
    ...
    public function testSearchReturnsAnEmptyStringWhenSearchingForANonExistentAddress(): void
    {
        ...
        $this->assertSame('', $osm->search($searchQuery, ResponseFormat::JSON));
    }
}
